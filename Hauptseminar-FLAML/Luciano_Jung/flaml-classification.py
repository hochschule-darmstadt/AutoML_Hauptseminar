...
train = pd.read_csv('../../Hauptseminar-ATM/Scheppat/phishing_train.csv', quotechar="'")
test = pd.read_csv('../../Hauptseminar-ATM/Scheppat/phishing_test.csv', quotechar="'")
...
for i in range(3):
    automl_settings = {
        ...
        "metric": 'f1',
        "task": 'classification',
        "log_file_name": 'log/flaml-classification.log',
        "verbose": -1
    }
    automl = AutoML()
