...
workspace_name = "hda-machine-learning-dev" # PLACEHOLDER
subscription_id = "b54a47bf-0c6e-4325-a485-38f7356ede13" # PLACEHOLDER
resource_group = "hda-auto-ml" # PLACEHOLDER
experiment_name = "experiment-0-percent-white" # PLACEHOLDER
iteration = "20"  # PLACEHOLDER
run_id = "AutoML_79c242ff-bb49-48c1-ae1d-d3fe66b35578_20"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'compute_target':'hda-compute-0','enable_dnn':False,'enable_code_generation':False,'experiment_exit_score':None,'experiment_timeout_minutes':30,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':1,'metric_operation':'minimize','model_explainability':True,'n_cross_validations':None,'name':'experiment-0-percent-white','path':'./sample_projects/experiment-0-percent-white','primary_metric':'normalized_root_mean_squared_error','region':'westeurope','resource_group':'hda-auto-ml','subscription_id':'b54a47bf-0c6e-4325-a485-38f7356ede13','task_type':'regression','validation_size':None,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'hda-machine-learning-dev','label_column_name':'percent_pell_grant','enable_batch_run':True,'enable_run_restructure':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','ensemble_iterations':15,'is_timeseries':False,'name':'experiment-0-percent-white','compute_target':'hda-compute-0','subscription_id':'b54a47bf-0c6e-4325-a485-38f7356ede13','region':'westeurope'}\",\"ensemble_run_id\":\"AutoML_79c242ff-bb49-48c1-ae1d-d3fe66b35578_20\",\"experiment_name\":\"experiment-0-percent-white\",\"workspace_name\":\"hda-machine-learning-dev\",\"subscription_id\":\"b54a47bf-0c6e-4325-a485-38f7356ede13\",\"resource_group_name\":\"hda-auto-ml\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"1d54b565-752a-4bc7-beed-374b0bac21ac\"},\"test_data\":{\"datasetId\":\"0c9d42cc-2920-4c54-b1b9-76054aedfb60\"}}" # PLACEHOLDER
