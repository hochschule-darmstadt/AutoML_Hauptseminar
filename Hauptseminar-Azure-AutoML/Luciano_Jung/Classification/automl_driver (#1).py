...
run_id = "AutoML_1a808da6-37d6-4a51-87f8-343f212c11c5_0"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'enable_early_stopping':True,'enable_ensembling':False,'enable_stack_ensembling':False,'ensemble_iterations':15,'enable_onnx_compatible_models':False,'max_cores_per_iteration':-1,'send_telemetry':True,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'compute_target':'hda-compute-0','enable_dnn':True,'enable_code_generation':False,'experiment_exit_score':None,'experiment_timeout_minutes':30,'featurization':'auto','is_timeseries':False,'iteration_timeout_minutes':30,'max_concurrent_iterations':1,'metric_operation':'maximize','model_explainability':True,'n_cross_validations':None,'name':'experiment-0-percent-white','path':'./sample_projects/experiment-0-percent-white','primary_metric':'AUC_weighted','region':'westeurope','resource_group':'hda-auto-ml','subscription_id':'b54a47bf-0c6e-4325-a485-38f7356ede13','task_type':'classification','validation_size':0.1,'test_size':None,'vm_type':'STANDARD_DS3_V2','workspace_name':'hda-machine-learning-dev','label_column_name':'\'Result\'','positive_label':None,'enable_batch_run':True,'enable_run_restructure':True} # PLACEHOLDER
...
dataprep_json = "{\"datasets\":0,\"training_data\":{\"datasetId\":\"cddbd810-d856-4423-83bb-845ea0ca2dee\"},\"test_data\":{\"datasetId\":\"95c4c367-a6a3-4a1f-8f52-d502201be106\"}}" # PLACEHOLDER
